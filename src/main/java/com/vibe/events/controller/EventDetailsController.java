...
public class EventDetailsController {
  ...
  public Map<String, Object> getSuccessRowDetail(
      @PathVariable String day,
      @PathVariable String eventKey,
      @PathVariable long id) {
    DayValidator.parseDay(day);
    Map<String, Object> row = recordsService.loadSuccessRowDetail(eventKey, id);
    if (row == null) {
      throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Success row not found");
    }
    return row;
  }

  @GetMapping("/failures/{id}")
  public Map<String, Object> getFailureRowDetail(
      @PathVariable String day,
      @PathVariable String eventKey,
      @PathVariable long id) {
    DayValidator.parseDay(day);
    Map<String, Object> row = recordsService.loadFailureRowDetail(eventKey, id);
    if (row == null) {
      throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Failure row not found");
    }
    return row;
  }
}
